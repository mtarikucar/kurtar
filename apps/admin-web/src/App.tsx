...
// Placeholder wiring only — Task 11 owns building out the real admin
// panel (auth flow, merchant approval, settlements, moderation) on top of
// this. See docs/frontend-contract.md for the client usage guide and the
// auth flow this app should implement (admin email+password, cookie
// transport).
